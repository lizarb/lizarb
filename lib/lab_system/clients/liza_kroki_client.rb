...
<%= render! :units, format: :plantuml %>
<%= render! :systems_in_objects, format: :plantuml %>
<%= render! :systems, format: :plantuml %>
<%= render! :boxes, format: :plantuml %>
<%= render! :subs, format: :plantuml %>
<%= render! :objects, format: :plantuml %>
