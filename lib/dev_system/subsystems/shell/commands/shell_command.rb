class DevSystem::ShellCommand < DevSystem::SimpleCommand
  ...
  def call_default
    ...
    puts "App.permanent_directory #{ App.permanent_directory }/"
    puts "App.data_directory      #{ App.data_directory }/"
    puts "App.temporary_directory #{ App.temporary_directory }/"
    puts
